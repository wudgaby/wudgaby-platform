 ...
 */
@ThreadSafe
public class MySensitiveContextValueFilter implements ContextValueFilter {
    private static final TransmittableThreadLocal<SensitiveContext> ttl = new TransmittableThreadLocal<>();
    ...
    public Object process(BeanContext context, Object object, String name, Object value) {
        ...
        SensitiveContext sensitiveContext = SensitiveContext.newInstance();
        ttl.set(sensitiveContext);
