...
import com.wudgaby.platform.flowable.helper.vo.ProcessDefinitionStVo;
import com.wudgaby.platform.flowable.helper.vo.ProcessInstanceQueryStVo;
...
public interface FlowableCommonMapper {
     ...
     * @return
     */
    List<ProcessDefinitionStVo> listMyInvolvedSummary(ProcessInstanceQueryStVo processInstanceQueryVo);
}
