...
public class FlowableUtils {
    public static User getFlowableUser() {
        ...
        currentUser.setDisplayName("test");
        return currentUser;
    }
    ...
    public static Map<String, Set<String>> getSpecialGatewayElements(FlowElementsContainer container, Map<String,
        ...
        for (FlowElement flowElement : flowelements) {
            boolean isBeginSpecialGateway =
                    flowElement.getId().endsWith(FlowableConst.SPECIAL_GATEWAY_BEGIN_SUFFIX) && (flowElement instanceof ParallelGateway || flowElement instanceof InclusiveGateway || flowElement instanceof ComplexGateway);
            if (isBeginSpecialGateway) {
                ...
                findElementsBetweenSpecialGateway(flowElement,
                        gatewayId + FlowableConst.SPECIAL_GATEWAY_END_SUFFIX, gatewayIdContainFlowelements);
    ...
    public static String getFlowableAttributeValue(BaseElement element, String name) {
        return element.getAttributeValue(FlowableConst.FLOWABLE_NAMESPACE, name);
    }
