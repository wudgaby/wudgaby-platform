...
import com.wudgaby.platform.core.annotation.ComparisonFiledInclude;
import com.wudgaby.platform.core.vo.FieldDiffVO;
...
public class ComparisonReflectUtil {
    ...
    public static List<FieldDiffVO> getDiffFields(Object source, Object target) {
            ...
            try {
                ...
                if(isNotEquals){
                    ...
                    if(fieldType == Date.class
                        ...
                        String oldDate = Optional.ofNullable(DateUtil.format((Date)sourceVal, fieldAnnotation.format())).orElse(null);
                        String newDate = Optional.ofNullable(DateUtil.format((Date)targetVal, fieldAnnotation.format())).orElse(null);
                    ...
                    if(fieldType == LocalDateTime.class
                            && StringUtils.isNotBlank(fieldAnnotation.format())){
                        String oldDate = Optional.ofNullable(DateUtil.format(LocalDateTimeUtil.convertLDTToDate((LocalDateTime)sourceVal), fieldAnnotation.format())).orElse(null);
                        String newDate = Optional.ofNullable(DateUtil.format(LocalDateTimeUtil.convertLDTToDate((LocalDateTime)targetVal), fieldAnnotation.format())).orElse(null);
                        fieldDiffVOs.add(new FieldDiffVO(filedDescName, fieldAnnotation.ignoreContent(), oldDate, newDate));
                        continue;
                    }
                    ...
                    if(isSimpleField(fieldType)){
                        ...
                        //枚举值处理
                        if(sourceVal != null){
                            Method sourceDescMethod = sourceVal.getClass().getMethod("getName");
                        ...
                        if(targetVal != null){
                            Method targetDescMethod = targetVal.getClass().getMethod("getName");
