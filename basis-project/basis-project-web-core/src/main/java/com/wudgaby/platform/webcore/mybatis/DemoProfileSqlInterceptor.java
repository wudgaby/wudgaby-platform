...
public class DemoProfileSqlInterceptor implements Interceptor {
    ...
    public DemoProfileSqlInterceptor(){}
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (SqlCommandType.SELECT.equals(mappedStatement.getSqlCommandType())) {
            ...
            if(RequestContextHolderSupport.getRequestAttributes() == null) {
                return invocation.proceed();
            }
            ...
            if(CollUtil.isNotEmpty(NONE_SECURITY_URL_PATTERNS)) {
                for (String notAuthResource : NONE_SECURITY_URL_PATTERNS) {
                    ...
                    if (antPathMatcher.match(notAuthResource, RequestContextHolderSupport.getRequest().getRequestURI())) {
                        return invocation.proceed();
                    }
                }
            }
