...
public enum RegionEnum {
    ...
    public static RegionEnum getByIsoCode(String iso_code) {
        for (RegionEnum region : RegionEnum.values()) {
            if (region.getIso_code().equalsIgnoreCase(iso_code)) {
                return region;
            }
        }
    ...
    public static RegionEnum getByIsoName(String iso_name) {
        for (RegionEnum region : RegionEnum.values()) {
            if (region.getIso_name().equalsIgnoreCase(iso_name)) {
                return region;
            }
        }
    ...
    public static RegionEnum getByRegionAddress(RegionInfo adress) {
        for (RegionEnum region : RegionEnum.values()) {
