...
public class MinioTemplateImpl implements MinioTemplate {
    ...
    public String putObject(MultipartFile file) {
        ...
        // 开始上传
        this.putMultipartFile(ossProperties.getBucket(), fileName, file);
        return ossProperties.getUrl() + "/" + ossProperties.getBucket() + "/" + fileName;
    }
    ...
    public String putObject(String objectName, InputStream inputStream, String contentType) {
        ...
        // 开始上传
        this.putInputStream(ossProperties.getBucket(), fileName, inputStream, contentType);
        return ossProperties.getUrl() + "/" + ossProperties.getBucket() + "/" + fileName;
    }
    ...
    public String putObject(String objectName, byte[] bytes, String contentType) {
        ...
        String fileName = getFileName(objectName);
        // 开始上传
        this.putBytes(ossProperties.getBucket(), fileName, bytes, contentType);
        return ossProperties.getUrl() + "/" + ossProperties.getBucket() + "/" + fileName;
    }
    ...
    public String putObject(String objectName, MultipartFile file) {
        ...
        // 开始上传
        this.putMultipartFile(ossProperties.getBucket(), objectName, file);
        return ossProperties.getUrl() + "/" + ossProperties.getBucket() + "/" + objectName;
    }
    ...
    public String putObject(String bucketName, String objectName, MultipartFile file) {
        ...
        return ossProperties.getUrl() + "/" + bucketName + "/" + objectName;
    }
    ...
    public String putObject(String bucketName, String objectName, InputStream inputStream, String contentType) {
        ...
        return ossProperties.getUrl() + "/" + bucketName + "/" + fileName;
    }
    ...
    public String putObject(String objectName, File file, String contentType) {
        ...
        String fileName = getFileName(objectName);
        // 开始上传
        this.putFile(ossProperties.getBucket(), fileName, file, contentType);
        return ossProperties.getUrl() + "/" + ossProperties.getBucket() + "/" + fileName;
    }
    ...
    public Boolean checkFileIsExist(String objectName) {
        return this.checkFileIsExist(ossProperties.getBucket(), objectName);
    }

    @Override
    public Boolean checkFolderIsExist(String folderName) {
        return this.checkFolderIsExist(ossProperties.getBucket(), folderName);
    }
    ...
    public void removeObject(String objectName) {
        this.removeObject(ossProperties.getBucket(), objectName);
    }
