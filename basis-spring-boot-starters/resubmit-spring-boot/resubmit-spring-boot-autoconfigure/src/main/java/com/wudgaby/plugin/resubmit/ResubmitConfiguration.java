...
public class ResubmitConfiguration {
    ...
    public RepeatSubmitAspect repeatSubmitAspect(@Autowired(required = false) RedisSupport redisSupport,
                                                 @Autowired(required = false) LoginUserService loginUserService) {
